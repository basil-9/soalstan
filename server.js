...
// وضعنا الأسئلة هنا مباشرة لتجاوز خطأ Render في قراءة الملفات
let questionBank = [
  { "type": "image", "hint": "اختبار الصور", "q": "هل تظهر هذه الصورة (جبال الألب) بشكل سليم الآن؟", "img": "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600&q=80", "options": ["نعم تظهر", "لا", "ربما", "شاشة سوداء"], "a": "نعم تظهر" },
  { "type": "text", "hint": "رياضة: كأس العالم", "q": "من هو المنتخب الذي فاز بكأس العالم 2022؟", "options": ["فرنسا", "الأرجنتين", "البرازيل", "المغرب"], "a": "الأرجنتين" }
];
